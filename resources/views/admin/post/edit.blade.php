...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <form action="{{ route('post.update', $post->post_id) }}" method="post" id="form" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12" id="container">
                                                <textarea id="editor1" name="post_content">{{ $post->post_content }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 col-sm-3">
                            <div class="card card-default">
                                ...
                                <div class="card-footer d-flex justify-content-center">
                                    <button type="submit"
                                        class="btn bg-olive col-sm-4 ml-1">{{ __('update') }}</button>
