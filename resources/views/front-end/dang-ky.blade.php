                            ...
                            <form action="{{ route('referral.register') }}" method="post" id="form-validate">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <select id="advise_type_id" name="advise_type_id"
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control" id="student_tel"
                                            name="student_tel" placeholder="Số điện thoại">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control" id="student_age"
                                            name="student_age" placeholder="Độ tuổi">
                                    </div>
                                    <div class="form-group">
